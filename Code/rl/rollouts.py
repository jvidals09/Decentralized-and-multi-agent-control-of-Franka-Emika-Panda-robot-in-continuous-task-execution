...
class RolloutRunner(object):
    ...
    def run_episode(self, max_step=600, is_train=True, record=False):
        ...
        while not done and ep_len < max_step:
            curr_meta_ac, meta_ac_before_activation = meta_pi.act(ob, is_train=is_train)
            ...
            while not done and ep_len < max_step and meta_len < config.max_meta_len:
                ...
                env.render() #this fucker here needs to stay for the mojoco to render correctly.
    ...
    def _store_frame(self, info={}):
        ...
        text = "{:4} {}".format(self._env.episode_length,
                                self._env.episode_reward)
