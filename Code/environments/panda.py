...
class PandaEnv(MujocoEnv):
    ...
    def __init__(self, config, controller_config_file):
        ...
        """
        # env info
      #  self.ob_shape = OrderedDict([("right_arm", 9 + 9), ("left_arm", 9 + 9), ("right_hand", 7 + 3)])
     #   self.action_space.decompose(OrderedDict([("right_arm", 4), ("left_arm", 4)]))
...
#look here on how to load the model
        if self.has_gripper:
    ...
    def _pre_action(self, action, policy_step):
       ...
       # print('\n actionnnnnn',action)
        ...
        if self.has_gripper:
            ...
            #print('\n gripper action',gripper_action_actual)

            #gripper_action_actual = gripper_action_actual+0.3
           # print('\n gripper action multiplied',gripper_action_actual[2])
    ...
    def _get_observation(self):
        ...
        state["robot_state"] = np.concatenate(robot_states)
    ...
    def observation_space(self):
        ...
        print('\n in panda.py we print observations',observation)
        ob_space['object_state'] = [observation['object_state'].size]
        ob_space['robot_state'] =  [observation['robot_state'].size]
        
        print('\n panda.py this is returning ob_space',ob_space)
        return ob_space
    ...
    def action_space(self):
        ...
        action_space.py for more documentation.
        """
